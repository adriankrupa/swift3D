...
@warn_unused_result
func inversesqrt(v: float2) -> float2 {
    return float2(1) / sqrt(v)
}

/// Returns the reciprocal of the positive square root of v.
@warn_unused_result
func inversesqrt(v: float3) -> float3 {
    return float3(1) / sqrt(v)
}

/// Returns the reciprocal of the positive square root of v.
@warn_unused_result
func inversesqrt(v: float4) -> float4 {
    return float4(1) / sqrt(v)
}

/// Returns the reciprocal of the positive square root of v.
@warn_unused_result
func inversesqrt(v: double2) -> double2 {
    return double2(1) / sqrt(v)
}

/// Returns the reciprocal of the positive square root of v.
@warn_unused_result
func inversesqrt(v: double3) -> double3 {
    return double3(1) / sqrt(v)
}

/// Returns the reciprocal of the positive square root of v.
@warn_unused_result
func inversesqrt(v: double4) -> double4 {
