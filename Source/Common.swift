...
/// NaN, the result is `min`.
@warn_unused_result
func clamp(value: Double, lower: Double, upper: Double) -> Double {
    return min(max(value, lower), upper)
}
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: float2) -> float2 {
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: float3) -> float3 {
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: float4) -> float4 {
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: Double) -> Double {
    let fractionalPart = fract(x)
    let integer = Int(x)
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: double2) -> double2 {
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: double3) -> double3 {
...
/// integer. (Both 3.5 and 4.5 for x will return 4.0.)
@warn_unused_result
func roundEven(x: double4) -> double4 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: float2, _ y: Float) -> float2 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: float3, _ y: Float) -> float3 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: float4, _ y: Float) -> float4 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: float2, _ y: float2) -> float2 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: float3, _ y: float3) -> float3 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: float4, _ y: float4) -> float4 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: double2, _ y: Double) -> double2 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: double3, _ y: Double) -> double3 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: double4, _ y: Double) -> double4 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: double2, _ y: double2) -> double2 {
    return double2(mod(x[0], y[0]), mod(x[1], y[1]))
}

/// Modulus. Returns x - y * floor(x / y)
/// for each component in x using the floating point value y.
func mod(x: double3, _ y: double3) -> double3 {
...
/// for each component in x using the floating point value y.
@warn_unused_result
func mod(x: double4, _ y: double4) -> double4 {
...
@warn_unused_result
func modf(x: float2) -> (float2, float2) {
    let y = trunc(x)
    return (y, x - y)
}
...
/// part of x. Both the return values will have the same sign as x.
@warn_unused_result
func modf(x: float3) -> (float3, float3) {
    let y = trunc(x)
    return (y, x - y)
}
...
/// part of x. Both the return values will have the same sign as x.
@warn_unused_result
func modf(x: float4) -> (float4, float4) {
    let y = trunc(x)
    return (y, x - y)
}
...
/// part of x. Both the return values will have the same sign as x.
@warn_unused_result
func modf(x: double2) -> (double2, double2) {
    let y = trunc(x)
    return (y, x - y)
}
...
/// part of x. Both the return values will have the same sign as x.
@warn_unused_result
func modf(x: double3) -> (double3, double3) {
    let y = trunc(x)
    return (y, x - y)
}
...
/// part of x. Both the return values will have the same sign as x.
@warn_unused_result
func modf(x: double4) -> (double4, double4) {
    let y = trunc(x)
    return (y, x - y)
}
...
@warn_unused_result
func smoothstep(x: Float, edge0: Float, edge1: Float) -> Float {
...
/// you would want a threshold function with a smooth
@warn_unused_result
func smoothstep(x: Double, edge0: Double, edge1: Double) -> Double {
    let t = clamp ((x - edge0) / (edge1 - edge0), lower: 0, upper: 1)
    return t * t * (3 - 2 * t);
}
...
@warn_unused_result
func frexp(x: float2) -> (float2, int2) {
    let f1 = frexp(x[0])
    let f2 = frexp(x[1])
...
/// x = significand * exp(2, exponent)
@warn_unused_result
func frexp(x: float3) -> (float3, int3) {
    let f1 = frexp(x[0])
    let f2 = frexp(x[1])
    let f3 = frexp(x[2])
...
/// x = significand * exp(2, exponent)
@warn_unused_result
func frexp(x: float4) -> (float4, int4) {
    let f1 = frexp(x[0])
    let f2 = frexp(x[1])
    let f3 = frexp(x[2])
    let f4 = frexp(x[3])
...
/// x = significand * exp(2, exponent)
@warn_unused_result
func frexp(x: double2) -> (double2, int2) {
    let f1 = frexp(x[0])
    let f2 = frexp(x[1])
...
/// x = significand * exp(2, exponent)
@warn_unused_result
func frexp(x: double3) -> (double3, int3) {
    let f1 = frexp(x[0])
    let f2 = frexp(x[1])
    let f3 = frexp(x[2])
...
/// x = significand * exp(2, exponent)
@warn_unused_result
func frexp(x: double4) -> (double4, int4) {
    let f1 = frexp(x[0])
    let f2 = frexp(x[1])
    let f3 = frexp(x[2])
    let f4 = frexp(x[3])
...
@warn_unused_result
func ldexp(x: float2, exp: int2) -> float2 {
...
/// significand * exp(2, exponent)
@warn_unused_result
func ldexp(x: float3, exp: int3) -> float3 {
...
/// significand * exp(2, exponent)
@warn_unused_result
func ldexp(x: float4, exp: int4) -> float4 {
...
/// significand * exp(2, exponent)
@warn_unused_result
func ldexp(x: double2, exp: int2) -> double2 {
...
/// significand * exp(2, exponent)
@warn_unused_result
func ldexp(x: double3, exp: int3) -> double3 {
...
/// significand * exp(2, exponent)
@warn_unused_result
func ldexp(x: double4, exp: int4) -> double4 {
